...
public class NormalVertexDataPool {
    ...
    public static void onDebugList(RenderGameOverlayEvent.Text event) {
        ...
        if (minecraft.gameSettings.showDebugInfo) {
            ...
            list.add(String.format("%s%s%s: %s vertex data arrays processed. %s unique, %s deduplicated.", TextFormatting.AQUA, "<TwelvefoldASM>", TextFormatting.RESET, deduplicatedCount, uniqueCount, deduplicatedCount - uniqueCount));
        }
    }
