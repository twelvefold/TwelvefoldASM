...
public class NormalConfig {
    ...
    public boolean squashBakedQuads, logClassesThatCallBakedQuadCtor, reuseBucketQuads, bakedQuadDynaTreeCompat;
    ...
    private void initialize() {
        configuration = new Configuration(new File(Launch.minecraftHome, "config" + File.separator + "twelvefoldasm.cfg"));
        load();
    }
